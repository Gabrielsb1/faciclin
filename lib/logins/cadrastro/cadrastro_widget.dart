...
import 'cadrastro_model.dart';
export 'cadrastro_model.dart';

class CadrastroWidget extends StatefulWidget {
  const CadrastroWidget({Key? key}) : super(key: key);

  @override
  _CadrastroWidgetState createState() => _CadrastroWidgetState();
}

class _CadrastroWidgetState extends State<CadrastroWidget> {
  late CadrastroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadrastroModel());
    ...
    _model.textFieldConfirmarSenhaController ??= TextEditingController();
    _model.textFieldConfirmarSenhaFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: scaffoldKey,
      backgroundColor: Color(0xFF833FFB),
      body: Container(
        width: double.infinity,
        height: double.infinity,
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFFF600E5), Color(0xFF833FFB), Color(0xFF03F9FF)],
            stops: [0.0, 0.5, 1.0],
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.textFieldConfirmarSenhaController,
                                focusNode:
                                    _model.textFieldConfirmarSenhaFocusNode,
                                autofocus: true,
                                textCapitalization: TextCapitalization.none,
                                obscureText:
                                    !_model.textFieldConfirmarSenhaVisibility,
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: InkWell(
                                    onTap: () => setState(
                                      () => _model
                                              .textFieldConfirmarSenhaVisibility =
                                          !_model
                                              .textFieldConfirmarSenhaVisibility,
                                    ),
                                    focusNode: FocusNode(skipTraversal: true),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.textFieldSenhaController.text !=
                                      _model.textFieldConfirmarSenhaController
                                          .text) {
