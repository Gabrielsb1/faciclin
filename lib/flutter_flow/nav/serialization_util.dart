  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AnamnesesRow:
            return AnamnesesRow(data);
          case DentistasRow:
            return DentistasRow(data);
          case HistoricoMedicoRow:
            return HistoricoMedicoRow(data);
          case ConsultasRow:
            return ConsultasRow(data);
          case PacienteAnexosRow:
            return PacienteAnexosRow(data);
          case TermosConsentimentoRow:
            return TermosConsentimentoRow(data);
          case AnexosRow:
            return AnexosRow(data);
          case ModelosEvolucaoRow:
            return ModelosEvolucaoRow(data);
          case UsuariosRow:
            return UsuariosRow(data);
          case UsersRow:
            return UsersRow(data);
          case PacientesRow:
            return PacientesRow(data);
          case ProcedimentosRow:
            return ProcedimentosRow(data);
          case TratamentosRow:
            return TratamentosRow(data);
          default:
            return null;
        }
